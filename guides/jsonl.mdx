...
See our documentation on [enabling JSON lines responses](https://www.speakeasy.com/docs/customize/runtime/jsonl-events) for detailed information on how to best prepare your OpenAPI spec for streaming JSONL responses.
