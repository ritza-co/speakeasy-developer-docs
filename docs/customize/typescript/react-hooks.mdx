...
- To enable React Hooks in your configuration, open the `.speakeasy/gen.yaml` file in your SDK directory and add the `enableReactQuery` flag to it:
...
- Once you've generated your SDK with React Hooks, you need to install it in your React application.
  ...
  - If you've published your SDK to a package registry like npm, you can install it directly:
...
More advanced uses of React Hooks include the following:
...
### Using infinite queries for pagination
...
- Explore how to set up your [SDK documentation](/docs/sdk-docs)
