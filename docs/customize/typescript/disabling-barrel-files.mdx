...
Disabling barrel files provides optimal tree shaking performance when combined with `moduleFormat: dual`. The ESM format&apos;s static analysis capabilities work best with direct imports, allowing bundlers to eliminate unused code more effectively.
</Callout>
...
<Callout title="Note" type="info">
  This article draws information from [Why you
