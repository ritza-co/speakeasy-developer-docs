...
**What you need to change:** Use elicitation to request user input when your tools need additional information.
...
**Example flow:**
1. Tool detects missing context (e.g., user asks to "format the data" but doesn't specify format)
2. Server sends elicitation request with schema for format preference
3. Client presents UI to user (form, dialog, etc.)
4. User provides response or declines
5. Tool continues with the additional context
