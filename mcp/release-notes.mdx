...
<Callout title="Note" type="info">
 This page is not an official MCP release notes page. It exists to help developers understand what changed, why it matters, and how to adopt the latest MCP revisions. For the full changelog, refer to the official <a href="https://github.com/modelcontextprotocol/modelcontextprotocol/tags" target="_blank">GitHub tags</a>.
</Callout>
