...
- `browser_navigate_back`: Select browser back button  
- `browser_navigate_forward`: Select browser forward button
...
This results in a **total 26 tools** for what should be straightforward browser automation.
...
Not to mention that not all clients support tool curation. For example, Claude Code and Gemini CLI don't offer tool curation at all. And ther clients, like Copilot, limit how many tools you can provide to the agent at once.
