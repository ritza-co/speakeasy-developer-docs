...
![A screenshot of Claude Desktop with steps highlighted to click on the Claude menu bar item, then click on Settings, then on Developer, finally on Edit Config.](./assets/quick-start/claude-mcp-config.png?.url)
