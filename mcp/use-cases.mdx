...
### Managing pull requests using GitHub MCP server

For example, here we use the GitHub MCP server to check the status of a recent pull request:

> get status of my context7 pr

import claudePrWebm from "./assets/use-cases/claude-pr.webm";
import claudePrMp4 from "./assets/use-cases/claude-pr.mp4";
...
>
  <source src={claudePrWebm} type="video/webm" />
  <source src={claudePrMp4} type="video/mp4" />
</video>
...
import claudeBranchesWebm from "./assets/use-cases/claude-branches.webm";
import claudeBranchesMp4 from "./assets/use-cases/claude-branches.mp4";
...
<video
  ...
  className="max-w-6xl mx-auto my-10"
>
  <source src={claudeBranchesWebm} type="video/webm" />
  <source src={claudeBranchesMp4} type="video/mp4" />
</video>

Here we see Claude deleting the local branch and renaming the master branch to main. How's that for convenience?
...
Context7 is one of the most popular MCP servers for software development. It can help your AI coding assistant find the most recent documentation and code examples for more than 21,000 libraries and frameworks. This helps fill in the gaps in knowledge that LLMs have due to training cutoffs. Even for older versions of libraries, Context7 can help your assistant find code snippets for specific versions of libraries. This greatly reduces hallucinations.
...
import claudeContext7Webm from "./assets/use-cases/claude-context7.webm";
import claudeContext7Mp4 from "./assets/use-cases/claude-context7.mp4";
...
<video
  ...
  className="max-w-6xl mx-auto my-10"
>
  <source src={claudeContext7Webm} type="video/webm" />
  <source src={claudeContext7Mp4} type="video/mp4" />
</video>
...
import claudePythonWebm from "./assets/use-cases/claude-python.webm";
import claudePythonMp4 from "./assets/use-cases/claude-python.mp4";
...
<video
  ...
  className="max-w-6xl mx-auto my-10"
>
  <source src={claudePythonWebm} type="video/webm" />
  <source src={claudePythonMp4} type="video/mp4" />
</video>
...
### Browser automation using MCP Playwright

We'll use the MCP Playwright server to automate browser tasks. This is particularly useful for testing web applications, scraping data, or even just finding information online. So let's ask Claude to open a browser and help us with comparative shopping:

> Find three cheap aluminium 60% mechanical keyboards in beige or grey on Aliexpress.

import claudeBrowserWebm from "./assets/use-cases/claude-browser.webm";
import claudeBrowserMp4 from "./assets/use-cases/claude-browser.mp4";
...
<video
  ...
  className="max-w-6xl mx-auto my-10"
>
  <source src={claudeBrowserWebm} type="video/webm" />
  <source src={claudeBrowserMp4} type="video/mp4" />
</video>

Claude opens the browser, searches for the keyboards, and finds three options.

Your AI coding assistant can use the MCP Playwright server to automate testing, or take screenshots of your site while it tries to fix CSS issues. The Playwright server can also be used to automate any web-based tasks, like filling out forms or scraping data.

## Getting started with these use cases

You can use these examples in Claude Desktop by adding the following to your `claude_desktop_config.json` file:
