...
If you've created your server using [Gram](https://docs.getgram.ai/host-mcp/deploy-mcp-server), we recommend hosting it there for a more streamlined experience.
...
- For Gram-hosted servers, follow the guide to [OAuth implementation with Gram](https://docs.getgram.ai/examples/oauth-external-server).
- For self-hosted servers, follow the guide to [general OAuth implementation for MCP](https://docs.getgram.ai/host-mcp/adding-oauth).
