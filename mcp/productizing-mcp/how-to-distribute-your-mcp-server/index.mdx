...
- You can package your MCP server in MCPB (formerly DXT) extension installable, which is user-friendly.
...
You need to know a bit about MCP servers transports as they determine how you output your MCP server and how you receive inputs.
...
![Flowchart for selecting an option](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/image-20250918034511676.png)
...
![Testing local build](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 06.25.59@2x.png)
...
If you're creating an MCP server that exposes API capabilities and you have an OpenAPI document, you can use Speakeasy to generate a TypeScript MCP server ready for deployment and distribution. You can learn more about the process here.
...
![Selecting NPM built package](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 06.02.21@2x.png)
...
![Test results](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 06.03.57@2x.png)

To make release and distribution easier, you should consider CI/CD tools to automate the process. You can find a GitHub Action for that here.

## Distributing your MCP server as an MCPB package

MCP bundles (formerly DXT) is a zip archive extension developed by Anthropic to make MCP server installation easier with one click. An MCPB package contains the local MCP server and a `manifest.json` file describing its capabilities.
...
![Configuring the Manifest file](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.10.58@2x.png)
...
![Advanced settings button](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.23.13@2x.png)
...
![Adding the MCP server in Claude](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.38.01@2x.png)
...
![CleanShot 2025-09-18 at 05.32.01@2x](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.32.01@2x.png)

Once the name is entered, save the changes and open a new conversation in Claude. Make sure the MCP server is activated.

![Selecting MCP echo input server](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.40.36@2x.png)
...
![Testing the MCP server](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 05.42.16@2x.png)

We have a working `.mcpb` file that you can upload to artifact repositories so users can download and install your MCP server. If you're using CI/CD pipelines, we have a GitHub Action here that builds your `.mcpb` file and publishes it to the GitHub registry automatically on new releases.
...
- Simple installation in Claude Desktop where remote MCP servers appear as Connectors.
  ...
  ![Connectors](/Users/koladev/ritza/speakeasy-developer-docs/mcp/productizing-mcp/how-to-distribute-your-mcp-server/assets/CleanShot 2025-09-18 at 06.31.20@2x.png)
...
- Use Gram, a platform we developed to create, host and distribute MCP servers with just an OpenAPI document.
