...
MCP (Model Context Protocol) lets Claude Desktop connect to external services like Slack to read and analyze your messages directly in the chat interface. ![Diagram showing data flow for Slack MCP server](/Users/koladev/ritza/speakeasy-developer-docs/mcp/using-mcp/slack-claude-quickstart/assets/data-flow.png)
...
This guide uses the [slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) open source project instead. This guide shows you how to set up a third-party Slack MCP server that acts as a bridge between your Slack workspace and Claude Desktop.

![Demo of the Slack integration](/Users/koladev/ritza/speakeasy-developer-docs/mcp/using-mcp/slack-claude-quickstart/assets/demo.gif)
...
2. Open the project and find the `conversation.go` file, which path is `slack-mcp-server/pkg/handler/conversations.go`.
