...
For this guide, we've built a basic Google Sheets API with three operations: reading sheet data, listing sheets, and getting spreadsheet details. Clone the [example repository](https://github.com/ritza-co/speakeasy-examples/pull/15), follow the `README` to deploy it and generate an OpenAPI document, then continue to the next section.
