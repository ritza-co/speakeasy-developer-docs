...
- You'll need both MCP servers installed:
  - Complete the [Slack MCP server guide](/mcp/using-mcp/slack-claude-quickstart).
  - Complete the [HubSpot MCP server guide](/mcp/using-mcp/hubspot-claude-quickstart).
