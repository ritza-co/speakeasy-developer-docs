---
title: Using MCP to turn your best Slack threads into social media posts
...
Claude schedules the posts on Postiz, and you can review them at [platform.postiz.com](https://platform.postiz.com/).
