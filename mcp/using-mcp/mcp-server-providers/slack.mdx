...
Claude Desktop supports MCP installations using DXT files. The [`slack-mcp-server`](https://github.com/korotovsky/slack-mcp-server) releases provide DXT files you can install in Claude Desktop. Download the release file on [GitHub](https://github.com/korotovsky/slack-mcp-server/releases).
