...
This guide shows you how to install the Postiz MCP server in Claude Desktop to generate and schedule content for [X](https://x.com/), [LinkedIn](https://linkedin.com/), and other platforms.

<video controls>
  <source src="./assets/postiz-mcp-demo.mp4" type="video/mp4">
...
- A [Postiz account](https://platform.postiz.com/auth) with at least one connected social media channel.
...
Try combining Postiz with other MCP servers to create advanced workflows, like turning your best [Slack threads](/mcp/using-mcp/slack-postiz-guide) into social media content.