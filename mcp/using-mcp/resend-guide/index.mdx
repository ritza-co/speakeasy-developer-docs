...
You need a Resend API key for the MCP server to authenticate with your account. In your Resend dashboard, go to API Keys. Click on the **Create API key button**.
