...
![Screenshot of Claude Desktop showing the generated content for the document](./assets/final-result.png)

This guide will show you how to connect the PandaDoc MCP Server to Claude Desktop.
...
![Screenshot of the PandaDoc dashboard highlighting the new template button](./assets/add-template.png)

Select **Blank Template**.

![Screenshot of the PandaDoc dashboard highlighting the blank template option](./assets/blank-template.png)
...
![Screenshot of the PandaDoc dashboard highlighting the template name and "Create document" button](./assets/rename-template.png)

Click **Create document**. 

## Retrieve the PandaDoc API key

In the PandaDoc dashboard, navigate to **Settings → API and Integrations**. Scroll down and click **API** under **API and Webhooks**.

![Screenshot of the PandaDoc "API and Integrations" configuration highlighting the "API" option](./assets/api-settings.png)
...
![Screenshot of PandaDoc settings showing where to copy the generated Sandbox key](./assets/sandbox-api-key.png)
...
![Screenshot of Claude Desktop highlighting the navigation path: Settings → Developer → Edit Config](./assets/claude-desktop-config-settings.png)
...
![Screenshot of Claude Desktop settings showing the response preferences field](./assets/response-preferences.png)
...
![Screenshot of Claude Desktop UI showing a response confirming the PandaDoc template has been found](./assets/find-template.png)

## Generate and share a document
...
![Screenshot of Claude Desktop UI showing the report has been successfully generated and emailed](./assets/generate-document.png)
...
![Screenshot of the email sent from PandaDoc with a link to the generated document](./assets/result-email.png)
...
![Screenshot of the generated document in PandaDoc](./assets/result-doc.png)
