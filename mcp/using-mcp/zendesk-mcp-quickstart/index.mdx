...
![Claude Desktop configuration](./assets/allow-api.png)
...
- `ZENDESK_SUBDOMAIN`: just the subdomain part from your Zendesk URL. For example, if your Zendesk URL is `https://mycompany-123.zendesk.com`, then use `mycompany-123`.
