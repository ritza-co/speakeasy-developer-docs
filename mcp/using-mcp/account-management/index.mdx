...
- **Python 3.11 or higher** – For running the Slack API server
...
- **Gram account** – To host your Slack MCP server
...
- Someone adds the ‼️reaction to the message indicating high priority. 
...
In HubSpot, navigate to Contacts -> Deals and click on the related to see the results.
