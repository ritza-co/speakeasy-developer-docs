...
Open Cursor and navigate to **Settings** > **Cursor Settings**, then click on the **Tools & Integrations** tab. Look for the MCP section and click the **Add Custom MCP** button to access the configuration interface.
