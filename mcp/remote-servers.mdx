...
If you encounter connection issues, you may need to disable Warp's DNS features. To do so, navigate to your Cloudflare Zero Trust dashboard and go to **Settings** > **Warp Client** > **Profile settings**. Select **Configure** from the three-dot menu option for your profile, and under **Service mode**, select **Secure Web Gateway without DNS Filtering**.
</Callout>
