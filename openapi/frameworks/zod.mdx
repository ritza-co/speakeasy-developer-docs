...
### 10. Add a Schema for Creating Burgers
...
### 11. Add Order Schemas and Operations
...
const orderSchema = z3.object({
  id: OrderIdSchema,
  burger_ids: z3.array(BurgerIdSchema).min(1).openapi({
...
### 12. Define Burger and Order Operations
...
### 13. Add a Webhook That Runs When a Burger Is Created
...
### 14. Register All Paths, Webhooks, and Extensions
...
### 15. Generate the OpenAPI Schema
