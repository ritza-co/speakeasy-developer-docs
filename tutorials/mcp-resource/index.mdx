...
MCP resources give LLMs direct access to extensive reference material like comprehensive documentation, complete log files, full configuration files, or substantial codebases. This material remains available as context throughout the entire conversation. For example, instead of manually finding and copying a project's `README.md` file when asking installation questions, you can set up the README as a resource so Copilot automatically has access to setup instructions during the conversation.
...
While [Claude Desktop](https://claude.ai/download) supports MCP resources on Pro and Team plans, it doesn't support resource templating, so you can't pass parameters to specify dynamic content to generate.
...
Using MCP resources to provide persistent context to your AI assistants eliminates the need to manually find and copy relevant information into every conversation.

MCP resources work with many types of content beyond documentation and code files. Consider what other knowledge bases, logs, or reference materials you regularly consult that could be made available as persistent context to improve your AI-assisted workflows.
